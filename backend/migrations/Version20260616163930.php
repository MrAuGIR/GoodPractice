 ...
 */
final class Version20260616163930 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Ajout des tags transverses (table tag + jointure article_tag) et du champ featured sur article.';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD featured TINYINT DEFAULT 0 NOT NULL');
    }
